...
- "we renamed `inherit-parent` to `inherit-parent` in `encodingForModel`"
...
- "skill-bundled scripts use their own npm package-lock.json, not the application workspace"
