...
6. Run `node skills/vstack/scripts/check-plan.mjs <plan.md>` from the installed collection and fix every line it prints (the **encode-lessons-in-structure** principle skill).
...
The program runs `skills/vstack/playbooks/<execution playbook>.md` from the installed collection. <Who merges, and which PR ids are the operator's items that stop at merge-ready.>
...
- [ ] Read these from the installed collection at program start. Re-read them at every tick.
  - [ ] `skills/vstack/playbooks/<execution playbook>.md`
  - [ ] `skills/swarm/SKILL.md`
  - [ ] `<driver skill path>`
  - [ ] `skills/vstack/playbooks/opening-a-pr.md`
