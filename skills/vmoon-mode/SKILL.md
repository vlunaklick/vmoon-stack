---
name: vmoon-mode
description: vmoon's agent style for concise, detailed responses, deliberate subagents, unslopped prose, simple code, and verified work. Use for vmoon, /vmoon-mode, or requests to work in this style.
---
