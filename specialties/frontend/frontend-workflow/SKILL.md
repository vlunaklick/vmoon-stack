...
Use this as the frontend specialization of vstack, not a replacement for its feature, bug-fix, verification or model-routing workflow. When invoked directly, read the installed vstack local policy first.
...
5. Report the visible result, verification and remaining limitations. Save task notes outside the project per vstack's policy.
